...
var JSONBingo = {
  squares: [
    ...
    { square: "Strategisch" },
    { square: "No Logging was implemented." },
    { square: "Der Markt bleibt herausfordernd." },
    { square: "Wir setzen auf Wachstum" },
    { square: "IT als Enabler" },
    { square: "Synergien nutzen." },
    { square: "Neue strategische Partnerschaften." },
    { square: "Wir haben ambitionierte Ziele." },
    { square: "X neue Mitarbeitende eingestellt." },
    { square: "Wir bleiben Marktführer in XYZ." },
    { square: "PowerPoint mit zu vielen Balkendiagrammen." },
    { square: "Jemand fragt nach Homeoffice-Regelungen." },
    { square: "Mitarbeiterzufriedenheit ist uns wichtig." },
    { square: "Wir investieren in Weiterbildung." },
    { square: "Zukunftsfähige Arbeitsmodelle" },
    { square: "Wer von euch ist schon über 10 Jahre dabei?" },
